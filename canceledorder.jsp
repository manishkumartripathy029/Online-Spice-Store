...
<html>
<head>
	<title>View Canceled Orders </title>
	<link rel="stylesheet" href="css/canceledorders.css" type="text/css" />
</head>
<body>
<form action="admin.jsp">
	<p align="center" class="p1">View Canceled Orders </p>
...
<table id="table" border=3 cellspacing=5 align="center">
	...
	<th style="color:white;font-size:25px;font-family:Times New Roman;font-style:italic;">Reason</th>
	<th style="color:white;font-size:25px;font-family:Times New Roman;font-style:italic;">Total</th>
	<th style="color:white;font-size:25px;font-family:Times New Roman;font-style:italic;">Clear</th>
	</tr>
		<tr class="alt">	

<%
String sql="select a.orderid,a.odate,a.cid,b.cname,a.reason,a.amt from orders a,customer b where a.status='canceled' and a.cid=b.cid;";
...
<a href="AdminDeleteAction.jsp?&oid=<%=rs.getInt(1)%>&frm=cancel">Remove</a>
</td>
</tr>
<%}
}
...
%>
<tr><th colspan=9 align="center"><input type="submit" value="Back To Home"></th></tr>
</table>
